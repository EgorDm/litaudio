...
macro_rules! impl_unary_float_op (
	($OpTrait: ident, $op_fn: ident, $OpAssignTrait: ident, $op_assign_fn: ident) => {
		impl<'a, T, C, L, P, S> $OpTrait for AudioSliceBase<'a, T, C, L, P, S>
			where
				T: Sample + Float, C: Dim, L: Dim, P: SamplePackingType, S: AudioStorage<T, C, L, P>
		{
		...
		impl<'a, T, C, L, P, S> $OpAssignTrait for AudioSliceBase<'a, T, C, L, P, S>
			where
...
impl<'a, T, C, L, P, S, RT> Pow<RT> for AudioSliceBase<'a, T, C, L, P, S>
	where
		T: Sample + num_traits::Pow<RT, Output=T>, C: Dim, L: Dim, P: SamplePackingType, S: AudioStorage<T, C, L, P>, RT: Sample
{
	type Output = <Self as OwnableAudio<T, C, L>>::OwnedAudioType;
...
impl<'a, T, C, L, P, S, RT> PowAssign<RT> for AudioSliceBase<'a, T, C, L, P, S>
	where
...
macro_rules! impl_binary_float_op (
	($OpTrait: ident, $op_fn: ident, $OpAssignTrait: ident, $op_assign_fn: ident) => {
		impl<'a, T, C, L, P, S> $OpTrait<T> for AudioSliceBase<'a, T, C, L, P, S>
			where
				T: Sample + Float, C: Dim, L: Dim, P: SamplePackingType, S: AudioStorage<T, C, L, P>
		{
			type Output = <Self as OwnableAudio<T, C, L>>::OwnedAudioType;
		...
		impl<'a, T, C, L, P, S> $OpAssignTrait<T> for AudioSliceBase<'a, T, C, L, P, S>
			where
				T: Sample + Float, C: Dim, L: Dim, P: SamplePackingType, S: AudioStorageMut<T, C, L, P>
		{
